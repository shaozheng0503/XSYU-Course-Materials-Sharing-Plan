...
## 🪟 平台选择
选择 GitHub 作为托管平台，主要基于以下考虑：

- **结构化管理**：GitHub 的目录与 README 展示机制，能够让资料按课程/主题分区，同时提供说明文档。
- **协作友好**：Issue 与 Pull Request 便于追踪任务、评审贡献，并记录讨论过程。
- **长期可持续**：相比临时群文件或个人网盘，仓库具备版本管理、权限控制与长期可访问性。

---

## 🙌 贡献方式
欢迎所有形式的贡献，包括但不限于：提交资料、修复错漏、补充选课/考试经验、协助整理目录结构等。
请随时通过 Issue 或 PR 与维护者沟通——来自大家的关注、维护和贡献，是项目持续更新的最大动力。
...
### 1. 提交 Pull Request
1. Fork 本仓库。
2. 在 GitHub 网页端点击 `Upload files` 上传资料，或使用本地 Git 工具提交。
3. 发起 PR 并附上简要说明。

> **Tips**
> - 上传到已有目录：进入目录后点击绿色 `Code` 按钮旁的 `Upload files`。
> - 上传到新目录：在上传页面修改地址栏中的路径，即可创建新文件夹。
> - 教师评价请使用姓名拼音首字母缩写；教师提供的课件请先获得授权或仅在 README 中提供链接。

### 2. 提交 Issue
如果不便直接上传文件，可在 Issue 中附加资料或说明，由维护者代为整理。

---

## 🔄 提醒
若长期维护自己的 Fork，可能出现提交历史落后主分支的情况：

- 对 Git 不熟悉：建议先做好备份，删除旧 Fork 后重新 Fork 并上传。
- 熟悉 Git：可在本地通过 `git pull --rebase upstream main` 等方式同步主分支历史。
...
- 盗版/付费电子书、付费软件安装包及破解资源。
- 未经授权的教师课件、受版权保护的内部资料。
- 其他可能侵犯版权或隐私的文件。

如认为仓库中的某些文件侵犯了您的权益，请通过 Issue 或邮箱联系维护者，我们将尽快处理。

---

## 📄 许可
除非另有说明，本仓库由贡献者编写部分遵循 **CC BY-NC-SA 4.0（署名-非商业性使用-相同方式共享）** 协议。
资料仅供参考，请根据自身情况判断其适用性。
